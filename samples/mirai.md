...
## reconstructing the encrypted string table
there was a table_init() call in main. after decompiling, the pseudocode can be used to reconstruct the table as follows:
| ID (Hex) | ID (Dec) | Encrypted Literal | Decrypted String | Purpose |
| :--- | :--- | :--- | :--- | :--- |
| `0x03` | 3 | `"\rRPMA\r\""` | `/proc/` | Process filesystem path |
| `0x04` | 4 | `"\rGZG\""` | `/exe` | Process binary link |
| `0x06` | 6 | `"\rOCRQ\""` | `/stat` | Process status file |
| `0x07` | 7 | `"\rRPMA\rLGV\rVAR\""` | `/proc/net/tcp` | Active TCP connections list |
...
| `0x17` | 23 | `"rpktoqe\""` | `TVIROSC` | Target process |
| `0x18` | 24 | `"rpktoqe\""` | `TVIROSC` | Target process |
| `0x19` | 25 | `"egvnmacnkr\""` | `GEPLCOAIMP` | Process name |
| `0x1a` | 26 | `"iknncvvi\""` | `KILLATTI` | Killer module directive |
| `0x1e` | 30 | `"c@cF\""` | `ABAb` | Command token |
| `0x1f` | 31 | `"KCeT\""` | `icGv` | Command token |
| `0x24` | 36 | `"\rFGT\rUCVAJFME\""` | `/dev/watchdog` | Watchdog device (disable reboot) |
| `0x2f` | 47 | `"\rFGT\rUCVAJFME\""` | `/dev/watchdog` | Watchdog device duplicate |
| `0x3c` | 60 | `"\rRPMA\rQGND\rGZG"` | `/proc/self/exe` | Self-binary location |
| `0x3d` | 61 | `"\rRPMA\rLGV\rVAR"` | `/proc/net/tcp` | Network sockets file |
| `0x3e` | 62 | `"\rFGT\rWPCLFMO"` | `/dev/ftwdt0` | Hardware watchdog |
| `0x3f` | 63 | `"\rAOFNKLG"` | `/bin/sh` | Command shell execution |
| `0x40` | 64 | `"\r@WQ[@MZ"` | `/bsobox` | Busybox alternative path |
| `0x41` | 65 | `"\rNK@\rQ[QVGOF"` | `/lib/systemd` | Systemd service directory |
| `0x42` | 66 | `"\rWQP\rNK@\r"` | `/usr/lib/` | System library path |
| `0x43` | 67 | `"UCVAJFME"` | `watchdog` | Target process/service name |
| `0x45` | 69 | `"VGNLGVF"` | `telnet` | Target service (port 23) |
| `0x47` | 71 | `"FPMR@GCP"` | `dvrboxer` | Target DVR process |
| `0x5a` | 90 | `"CLCGVWAN[\""` | `anewitaxyI` | User-agent/token string |
| `0x60` | 96 | `"\rWQP\r@KLEGV\""` | `/usr/bin/ev` | System execution path |
| `0x61` | 97 | `"\rWQP\rAWPN\""` | `/usr/curl` | Curl binary location |
| `0x62` | 98 | `"\rWQP\rVDVR\""` | `/usr/tftp` | TFTP download client |
| `0x63` | 99 | `"\rWQP\rDVR\""` | `/usr/dvr` | DVR execution path |
| `0x64` | 100 | `"\rWQP\rDGVAJ\""` | `/usr/fgetc` | Downloader path |
| `0x66` | 102 | `"Q[QVGOF\""` | `systemd` | Service daemon |
| `0x67` | 103 | `"@CQJPA\""` | `boxer` | Bot killer target |
| `0x6d` | 109 | `"PGNMCF\""` | `reload` | Shell/service command |
| `0x6e` | 110 | `"RGPQKQVG\""` | `persistent` | Persistence flag |
...
## domain substring parsing (MIPS disassembly, `LAB_0001b32c`)
